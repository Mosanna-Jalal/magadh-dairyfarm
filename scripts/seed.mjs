...
const PRODUCTS = [
  { name: "Milk", nameHindi: "दूध", slug: "milk", unit: "litre", price: 60, stock: 62, lowStockAt: 15, sortOrder: 1, emoji: "🥛", description: "Fresh whole milk from our cows and buffaloes, morning and evening — no water, no powder." },
